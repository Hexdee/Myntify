module myntify::simple_coin {
    ...
    fun init(witness: SIMPLE_COIN, ctx: &mut TxContext) {
        ...
        let icon_url = url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dltocubu4/image/upload/v1745755938/wfqtraxvraadccxrvqsx.png");
        ...
        // Freeze the 'CoinMetadataCap'
        transfer::public_freeze_object(cm_meta_cap);
