...
import type { IotaSignAndExecuteTransactionInput, IotaSignAndExecuteTransactionOutput } from '@iota/wallet-standard';
...
type UseSignAndExecuteTransactionArgs = PartialBy<Omit<IotaSignAndExecuteTransactionInput, 'transaction'>, 'account' | 'chain'> & {
